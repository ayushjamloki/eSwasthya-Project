...
const Appointment = () => {
    ...
    const [reviews, setReviews] = useState([]); // set reviews
  ...
  try {
    ...
    useEffect(() => {
        if (doctors.length > 0) {
            fetchDocInfo()
            fetchReviews();  // fetch reviews when doctor info loads
        }
    }, [doctors, docId])
...
<div className="sm:ml-72 sm:pl-4 my-12 font-medium text-[#565656]">
